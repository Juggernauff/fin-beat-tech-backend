...
namespace FinBeat.DAL.Repositories
{
    public interface IEntityRepository
    {
        ...
        public Task<int> AddEntitiesAsync(List<Entity> entities, CancellationToken cancellationToken = default);
        ...
        public Task<List<Entity>> GetEntitiesWithPaginationAsync(int pageNumber, int pageSize, EntityFilter filter, CancellationToken cancellationToken = default);
    }
}
